module.exports = [{
    ...
    $interactionreply[;{newEmbed:
        ...
        {description:
<:arsen_rp:1331899080154157106> *<@$get[kullanıcı]> adlı kullanıcı **$numberseparator[$getuservar[rp;$get[kullanıcı]];.] Kelime** roleplay yapmış.*
<:arsen_reply:1331899237306204172> ***$gettextsplitlength** kişi arasından **$findtextsplitindex[$get[kullanıcı]].** sıradasın.*
    ...
    $textsplit[$userleaderboard[$guildid;rp;asc;{id};$memberscount[$guildid;all;no];1];\n]
    $let[kullanıcı;$if[$slashoption[kullanıcı]==;$authorid;$slashoption[kullanıcı]]]
    $onlyif[$interactiondata[options._subcommand]==kelime;]
`}]